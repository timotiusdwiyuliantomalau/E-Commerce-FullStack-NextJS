              ...
              products.data.map((product: any, i: number) => (
                ...
                >
                  ...
                  <span className="pl-2 grid">
                    <Link href={`detail/${product.product_id}`} className=" mb-2 h-[3.5rem] overflow-hidden text-xl group-hover:underline">
                    ...
                    <p className=" text-gray-600 text-xl h-8 overflow-hidden hover:underline hover:group-[:nth-child(1)]:no-underline">J{product.offer.store_name}</p>
